...
import zgq.media.R;
import zgq.media.activity.AudioPlayerActivity;
import zgq.media.domain.MediaItem;
import zgq.media.utils.CacheUtils;

public class MusicPlayerService extends Service {

    public static final String OPENAUDIO = "zgq_OPENAUDIO";
...
//            notifyChange(OPENAUDIO);
    ...
    private void start() {
        ...
        Notification notification = new Notification.Builder(this)
                ...
                .setContentText("Playing:"+getName())
